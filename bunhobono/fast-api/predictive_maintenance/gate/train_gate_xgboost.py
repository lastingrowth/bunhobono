...
DATA_DIR = PROJECT_ROOT / "data" / "gate"
CSV_PATH = DATA_DIR / "gate_predictive_maintenance_synthetic_10000.csv"
TEST_DATA_PATH = DATA_DIR / "gate_predictive_maintenance_test.csv"
MODEL_DIR = PROJECT_ROOT / "model" / "gate"
MODEL_PATH = MODEL_DIR / "parking_gate_xgboost.json"
METADATA_PATH = MODEL_DIR / "parking_gate_xgboost_metadata.json"
...
def main() -> None:
    ...
    required = ["gate_id", "collected_at", *FEATURE_COLUMNS, TARGET_COLUMN]
